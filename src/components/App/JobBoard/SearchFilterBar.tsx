...
const SearchFilterBar = () => {
  const { placeholder, categories, experienceLevels } =
  ...
  return (
    <div className='flex flex-col lg:flex-row gap-4 bg-gray-50 dark:bg-gray-900/40 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-800/20'>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <select className='w-full sm:w-auto px-4 py-3.5 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/20 text-brandLight dark:text-brandDark cursor-pointer focus:ring-2 focus:ring-blue-500/20 min-w-0 sm:min-w-[180px] transition-all'>
